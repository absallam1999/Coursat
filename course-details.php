...
<html>
  ...
  <head>
    ...
    <title>كورس HTML  | كورسات مجانية </title>
  ...
  <section class="heading-page header-text" id="top">
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          <center>
          <h6>مشاهدة كورس HTML</h6>
          <h2>كورس تطوير الويب HTML </h2>
        </center>
        </div>
      </div>
    </div>
          ...
          <div class="row">
            <div class="col-lg-12">
              <div class="meeting-single-item">
                <div class="thumb">
                  ...
                  <div class="date">
                    <h6>درس  <span>12</span></h6>
                  </div>
                  <a href="course-details.php"><img src="style/images/hmtl.png" alt=""></a>
                </div>
                <div class="down-content">
                  <center>
                  <a href="course-details.php"><h4>كورس HTML</h4></a>
                  <p> تعلم لغة تطوير الويب html مجانا من موقع كورسات  </p>
                </center>
                  <p class="description">
                    هي لغة ترميز تستخدم في إنشاء وتصميم صفحات ومواقع الويب  <a href="index.php" target="_blank" rel="nofollow">HTML</a>وتعتبر هذه اللّغة من أقدم اللّغات وأوسعها استخداما في تصميم صفحات الويب. هيكل صفحة الويب وتعطي متصفّح الإنترنت وصفا لكيفيّة عرضه لمحتوياتها، يمكن أن تساعده تقنيات مثل أوراق الأنماط المتتالية (CSS) ولغات البرمجة النصية مثل جافا سكريبت تستقبل متصفحات الويب مستندات HTML من خادم الويب أو من نظام الملفات وتعرضها، ووظيفة لغة HTML هي وصف بنية صفحات الويب هيكليًا. <a rel="nofollow" href="index.php" target="_blank">العناصر في HTML </a>.هي اللبنة الأساسية لبناء مستندات HTML  <a href="index.php" target="_parent">إذ نستطيع عبرها إضافة الصور والكائنات التفاعلية مثل النماذج </a> أو ملفات الفيديو
                    
                    <br><br>يمكن للغة HTML أن تُضمِّن برامجَ مكتوبةٍ بلغات مثل جافا سكريبت لتعديل سلوك ومحتوى صفحات الويب؛ وإضافة شيفرات أوراق الأنماط المتتالية CSS تؤدي إلى تعريف شكل وتخطيط المحتوى.
                  </p>
                  <center>
                  <h4> محتوى الكورس  </h4> <br>
                  <iframe width="560" height="315" src="https://www.youtube.com/embed/videoseries?list=PLDoPjvoNmBAw_t_XWUFbBX-c9MafPk9ji" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                </center> <br> <br>
                  <div class="row">
                    <div class="col-lg-4">
                      <div class="hours">
            ...
            <div class="col-lg-12">
              <div class="main-button-red">
                <a href="courses.php"> الرجوع الى التصنيفات </a>
              </div>
            </div>
          </div>
        </div>
