...
<html>
  ...
  <head>
    ...
    <title>كورس RAILS  | كورسات مجانية </title>
  ...
  <section class="heading-page header-text" id="top">
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          <center>
          <h6>مشاهدة كورس RAILS</h6>
          <h2> كورس برمجة الويب RAILS </h2>
        </center>
        </div>
      </div>
    </div>
            ...
            <div class="col-lg-12">
              <div class="meeting-single-item">
                <div class="thumb">
                      <div class="price">
                        <span>
                          <i class="fa fa-clock-o" aria-hidden="true"></i> 6 ساعات
                        </span>
                      </div>
                  <div class="date">
                    <h6>درس  <span>44</span></h6>
                  </div>
                  <a href="#"></a>
                </div>
                <div class="down-content">
                  <center>
                  <a href="#"><h4>كورس RAILS</h4></a>
                  <p>  تعلم لغة برمجة الويب RAILS مجانا من موقع كورسات </p>
                </center>
                  <p class="description">
                    روبي أون ريلز (بالإنجليزية: <a href="../index.php" target="_blank" rel="nofollow">Ruby on Rails </a>)‏ ويرمز لها بالاختصار ROR وأحياناً تختصر باسم ریلز بصيغة الجمع (بالإنجليزية: Rails)‏ أي قضبان سكة القطار. وهي المنصة البرمجية لتطبيقات الإنترنت مفتوحة المصدر مبني على لغة روبي، ويعتزم استخدامها مع منهجية التطوير الذكية التي يتم استخدامها من قبل <a href="../index.php" target="_blank" rel="nofollow">المطورين على الشبكة العالمية </a>للتطوير السريع.
                  ...
                  <iframe width="560" height="315" src="https://www.youtube.com/embed/videoseries?list=PLMYF6NkLrdN_AvYsR6G6wTQM1zHlY77f2" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                </center> 
             <div class="col-lg-12">
