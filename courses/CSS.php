...
<html>
  ...
  <head>
    ...
    <title>كورس CSS  | كورسات مجانية </title>
  ...
  <section class="heading-page header-text" id="top">
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          <center>
          <h6>مشاهدة كورس CSS</h6>
          <h2> كورس تنسيق الويب CSS </h2>
        </center>
        </div>
      </div>
    </div>
            ...
            <div class="col-lg-12">
              <div class="meeting-single-item">
                <div class="thumb">
                      <div class="price">
                        <span>
                          <i class="fa fa-clock-o" aria-hidden="true"></i> 4 ساعات
                        </span>
                      </div>
                  <div class="date">
                    <h6>درس  <span>88</span></h6>
                  </div>
                  <a href="#"></a>
                </div>
                <div class="down-content">
                  <center>
                  <a href="#"><h4>كورس CSS</h4></a>
                  <p>  تعلم لغة تنسيق الويب CSS مجانا من موقع كورسات </p>
                </center>
                  <p class="description">
صفحات التنسيق النمطية (بالإنجليزية: Cascading Style Sheets)‏ اختصارًا: سي إس إس (بالإنجليزية: CSS)‏؛ هي لغة تنسيق لصفحات الويب تهتم بشكل وتصميم المواقع، صممت خصيصا لفصل التنسيق (الألوان - الخطوط - الأزرار....) عن محتوى المستند المكتوب (بلغة مثلا إتش تي إم إل <a href="../index.php" target="_blank" rel="nofollow">HTML</a>) وينطبق ذلك على الألوان والخطوط والصور والخلفيات التي تستخدم في الصفحات، بمرونة وسهولة تامة.
<br>
هذه التقنية تعنى <a href="../index.php" target="_blank" rel="nofollow">بالمظهر الكلي لصفحات </a>مواقع الويب من ألوان وصور وغيره. ويمكن إضافته للصفحة بعدة طرق أفضلها التضمين الخارجي بكتابة شفرة السي إس إس في ملف منفصل. وقد تم تطويرها لتصل حاليا إلى سي إس إس 3 والذي أضيف إليه عدة إضافات لم تكن متاحة في الإصدار السابق وكان إنجازها يتم فقط بجي كويري.
                  ...
                  <iframe width="560" height="315" src="https://www.youtube.com/embed/videoseries?list=PLDoPjvoNmBAzjsz06gkzlSrlev53MGIKe" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                </center> 
             <div class="col-lg-12">
